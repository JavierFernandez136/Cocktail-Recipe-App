const cocteles = [
    ...
    {
      nombre: 'Bocheitor',
      metodo: 'revolver con la chota',
      ingredientes: '2 oz de licor Bergamota especial, 1 oz de jugo de Mi Palo, 0.5 oz de jarabe Blanco',
      cristaleria: 'Vaso Forma de nepe',
      garnish: 'Decoración de autor',
      categoria: 'autor',
      imagen: '/mojito.jpg',
    },
